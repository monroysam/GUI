...
class GUI:
    def __init__(self):
        ...
        self.pass_entry = tkinter.Entry(self.pass_frame, width = 27, show = "*")
        ...
        self.confm_pass_entry = tkinter.Entry(self.confm_pass_frame, width = 21, show = "*")

        self.confm_pass_label.pack(side = "left")
        ...
        self.register_button = tkinter.Button(self.button_frame, text = "Register", command = self.register, font = register_font)
    ...
    def register(self):
        ...
        if self.radio_var.get() == 0:
            tkinter.messagebox.showinfo("Selection", message1)
            regg = False
        
        if self.term_var.get() == 0 or self.sub_var.get() == 0:
            tkinter.messagebox.showinfo("Selection", message2)
            regg = False

        if pass1 != pass2:
            tkinter.messagebox.showinfo("Selection", message3)
            regg = False

        if first_name == '':
            tkinter.messagebox.showinfo("Selection", message4)
            regg = False

        if last_name == '':
            tkinter.messagebox.showinfo("Selection", message5)
            regg = False

        if email == '':
            tkinter.messagebox.showinfo("Selection", message6)
            regg = False
